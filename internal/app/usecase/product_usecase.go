...
type ProductUseCase interface {
	...
	GetProductByFilter(discount []int , minPrice int , maxPrice int , subcategoryID []int) ([]entity.Product , error)
...
func (pu *productUseCase) GetProductByFilter(discount []int ,  minPrice int , maxPrice int , subcategoryID []int ) ([]entity.Product , error) { 
